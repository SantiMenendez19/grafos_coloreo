...
public class GrafoNPGenerador {

	public void aleatorioConProbabilidad(int cantNodos, double probabilidad) throws IOException {
	...
	public void aleatorioConPorcentajeAdyacencia(int cantNodos, double porcentaje) throws IOException {
		ArrayList<Arista> array = new ArrayList<Arista>();
	...
	public void regularConGrado(int cantNodos, int grado) throws IOException {
		ArrayList<Arista> array = new ArrayList<Arista>();
		int cantAristas = 0;
		int gradoActual = 2;
		int cantMaximaAristas = (cantNodos * (cantNodos - 1)) / 2;
	...
	public void regularConPorcentajeAdyacencia(int cantNodos, double porcentaje) throws IOException {
		int cantMaximaAristas = (cantNodos * (cantNodos - 1)) / 2;
	...
	public void nPartito(int cantNodos, int cantConjuntos) throws IOException {
		ArrayList<Arista> array = new ArrayList<Arista>();
	...
	private Arista calcularGrado(ArrayList<Arista> array, int cantNodos) {
	...
	private void escribirGrafoEnArchivo(String path, ArrayList<Arista> array, int cantNodos, int cantAristas,
	...
	private class RandomParDeNodos implements Comparable<RandomParDeNodos> {
